    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            if(my_threads == 1){
                ...
                th1.Join();
                sw.Stop();
                my_result = Sum_Global1;
            }
            else if(my_threads == 2){
                sw.Start();
                th1.Start();
                th2.Start();
                ...
                th2.Join();
                sw.Stop();
                my_result = Sum_Global1+ Sum_Global2;
            }
            else if(my_threads == 4){
                sw.Start();
                th1.Start();
                th2.Start();
                th3.Start();
                ...
                th4.Join();
                sw.Stop();
                my_result = Sum_Global1 + Sum_Global2 + Sum_Global3+ Sum_Global4;
            }
            else if(my_threads == 6){
                sw.Start();
                th1.Start();
                th2.Start();
                th3.Start();
                ...
                th6.Join();
                sw.Stop();
                my_result = Sum_Global1 + Sum_Global2 + Sum_Global3 + Sum_Global4 + Sum_Global5 + Sum_Global6;
            }
            else if(my_threads == 8){
                sw.Start();
                th1.Start();
                th2.Start();
                th3.Start();
                ...
                th8.Join();
                sw.Stop();
                my_result = Sum_Global1 + Sum_Global2 + Sum_Global3 + Sum_Global4 + Sum_Global5 + Sum_Global6 + Sum_Global7 + Sum_Global8;
            }
            else if(my_threads == 10){ 
                sw.Start();
                th1.Start();
                th2.Start();
                th3.Start();
                ...
                th10.Join();
                sw.Stop();
                my_result = Sum_Global1 + Sum_Global2 + Sum_Global3 + Sum_Global4 + Sum_Global5 + Sum_Global6 + Sum_Global7 + Sum_Global8 + Sum_Global9 + Sum_Global10;
            }
                ...
                th12.Join();
                sw.Stop();
                my_result = Sum_Global1 + Sum_Global2 + Sum_Global3 + Sum_Global4 + Sum_Global5 + Sum_Global6 + Sum_Global7 + Sum_Global8 + Sum_Global9 + Sum_Global10 + Sum_Global11 + Sum_Global12;
            }
            else if(my_threads == 14){ 
                sw.Start();
                th1.Start();
                th2.Start();
                th3.Start();
                ...
                th16.Join();
                sw.Stop();
                my_result = Sum_Global1 + Sum_Global2 + Sum_Global3 + Sum_Global4 + Sum_Global5 + Sum_Global6 + Sum_Global7 + Sum_Global8 + Sum_Global9 + Sum_Global10 + Sum_Global11 + Sum_Global12 + Sum_Global13 + Sum_Global14 + Sum_Global15 + Sum_Global16;
            }
            Console.WriteLine("Done.");
            Console.WriteLine("Summation result: {0}",my_result);
