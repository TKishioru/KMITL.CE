...
if (isset($_POST['change_info'])) {
    ...
    $E[12] = (empty($_POST['elective_eng3'])) ? 0 : 1;
    
    $interest = "{\"elective_eng1\":\"$E[0]\",\"elective_hu\":\"$E[1]\",\"elective_so1\":\"$E[2]\",\"elective_sci\":\"$E[3]\",\"elective_free\":\"$E[4]\",\"elective_life\":\"$E[5]\",\"elective_so2\":\"$E[6]\",\"elective_think\":\"$E[7]\",\"elective_manage\":\"$E[8]\",\"elective_eng2\":\"$E[9]\",\"elective_21\":\"$E[10]\",\"elective_carrer\":\"$E[11]\",\"elective_eng3\":\"$E[12]\"}";
